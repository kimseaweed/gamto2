...
public class KakaoPay {
    ...
    public String kakaoPayReady() {
        ...
        params.add("approval_url", "https://gamto.kro.kr/kakaoPaySuccess");
        params.add("cancel_url", "https://gamto.kro.kr/kakaoPayCancel");
        params.add("fail_url", "https://gamto.kro.kr/kakaoPaySuccessFail");
